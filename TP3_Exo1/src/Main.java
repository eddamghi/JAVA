...
public class Main {
    public static void main(String[] args) throws IOException {
        ContactsFolder contactsFolder = new ContactsFolder("C:\\Users\\lux\\OneDrive - usmba.ac.ma\\S3\\JAVA\\Homwork_3\\Contacts");
        int service;
    ...
    private static void addNewContact(ContactsFolder contactsFolder) throws IOException {
        Scanner _name = new Scanner(System.in);
    ...
    private static void searchContact(ContactsFolder contactsFolder) {
        Scanner _name = new Scanner(System.in);
        System.out.println("Name of contact you look for: ");
        String name = _name.nextLine();
